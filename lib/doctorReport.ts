...
function detectPatterns(scans: ScanResult[], checkIns: DailyCheckIn[], phase: CyclePhase): PatternAnalysis[] {
  ...
  if (wellnessAverages.stress.avg > 6) {
    patterns.push({
      description: `Higher stress wellness scores estimated (avg: ${wellnessAverages.stress.avg}/10), particularly during ${getPhaseDisplayName(phase)} phase`,
      frequency: "Ongoing",
    });
  }
...
<body>
  ...
  <div class="wellness-disclaimer-banner">
    <strong>WELLNESS REPORT — NOT A MEDICAL DOCUMENT</strong>
    This report summarizes wellness estimates from the IRIS app. It is not a medical assessment, diagnosis, or treatment recommendation. Please discuss any concerns with your healthcare provider.
  </div>
  ...
  ${patterns.length > 0 ? `
  <div class="section">
    <div class="section-title">Notable Wellness Patterns</div>
    ${patterns.map(p => `
  ...
  <div class="footer">
    ...
    <p><strong>WELLNESS ESTIMATES ONLY — NOT A MEDICAL DOCUMENT</strong></p>
    <p>This report is for informational purposes only. It is not a medical diagnosis, assessment, or treatment recommendation.</p>
