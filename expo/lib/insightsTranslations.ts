...
const stressData = {
  ...
  phaseContext: {
    menstrual: {
      en: "During menstruation, stress can feel higher for some women, especially when pain, poor sleep, or discomfort are present. Be gentle with yourself.",
      sv: "Under menstruation kan stress kännas högre för vissa kvinnor, särskilt när smärta, dålig sömn eller obehag är närvarande. Var snäll mot dig själv.",
      de: "Während der Menstruation kann sich Stress für manche Frauen stärker anfühlen, besonders bei Schmerzen, schlechtem Schlaf oder Unwohlsein. Sei sanft zu dir.",
      fr: "Pendant les menstruations, le stress peut sembler plus élevé pour certaines femmes, surtout en présence de douleurs, de mauvais sommeil ou d'inconfort. Soyez douce avec vous-même.",
      es: "Durante la menstruación, el estrés puede sentirse más alto para algunas mujeres, sobre todo si hay dolor, mal sueño o malestar. Sé amable contigo misma.",
      it: "Durante le mestruazioni, lo stress può sembrare più alto per alcune donne, soprattutto con dolore, sonno scarso o disagio. Sii gentile con te stessa.",
      nl: "Tijdens de menstruatie kan stress voor sommige vrouwen hoger aanvoelen, vooral bij pijn, slechte slaap of ongemak. Wees zacht voor jezelf.",
      pl: "Podczas menstruacji stres może wydawać się większy dla niektórych kobiet, zwłaszcza przy bólu, słabym śnie lub dyskomforcie. Bądź dla siebie łagodna.",
      pt: "Durante a menstruação, o stress pode parecer mais alto para algumas mulheres, especialmente com dor, mau sono ou desconforto. Seja gentil consigo mesma.",
    } as L,
    follicular: {
...
const hydrationData = {
  ...
  howToImprove: [
    { en: "Drink regularly through the day — your needs may vary", sv: "Drick regelbundet under dagen — ditt behov kan variera", de: "Trinken Sie regelmäßig über den Tag — der Bedarf kann variieren", fr: "Buvez régulièrement au cours de la journée — les besoins peuvent varier", es: "Bebe de forma regular durante el día — tus necesidades pueden variar", it: "Bevi regolarmente durante la giornata — le esigenze possono variare", nl: "Drink regelmatig over de dag — je behoefte kan variëren", pl: "Pij regularnie w ciągu dnia — potrzeby mogą się różnić", pt: "Beba regularmente ao longo do dia — as necessidades podem variar" } as L,
  ...
  phaseContext: {
    menstrual: { en: "During menstruation, some women feel better with regular fluids and consistent meals.", sv: "Under menstruation kan vissa kvinnor må bättre av regelbundna vätskor och jämna måltider.", de: "Während der Menstruation benötigen Sie möglicherweise zusätzliche Flüssigkeit.", fr: "Vous pourriez avoir besoin de plus d'hydratation pendant les menstruations.", es: "Podrías necesitar hidratación extra durante la menstruación.", it: "Potresti aver bisogno di idratazione extra durante le mestruazioni.", nl: "Je hebt mogelijk extra hydratatie nodig tijdens de menstruatie.", pl: "Możesz potrzebować dodatkowego nawodnienia podczas menstruacji.", pt: "Pode precisar de hidratação extra durante a menstruação." } as L,
  },
...
const inflammationData = {
  title: { en: "Irritation", sv: "Irritation", de: "Irritation", fr: "Irritation", es: "Irritación", it: "Irritazione", nl: "Irritatie", pl: "Podrażnienie", pt: "Irritação" } as L,
  whatWeMeasure: {
    en: "We read your eye photo for redness patterns and tear-film comfort, which may reflect irritation-related visual patterns and check-in trends. This is combined with your check-in data and cycle phase. This is not a medical assessment.",
    sv: "Vi läser av rödhet och tårfilmskomfort i ditt ögonfoto, vilket kan återspegla irritation-relaterade visuella mönster och incheckningstrender. Detta kombineras med din incheckningsdata och cykelfas. Detta är inte en medicinsk bedömning.",
